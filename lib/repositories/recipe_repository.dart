...
class RecipeRepository {
  static final List<Potion> potionsList = [
    Potion(
      ...
      bookAsset: 'assets/png/books/root_of_luck.png',
      angle: 13,
    ...
    Potion(
      ...
      bookAsset: 'assets/png/books/petal_brew.png',
      angle: 15,
    ...
    Potion(
      ...
      bookAsset: 'assets/png/books/whisper.png',
    ...
    Potion(
      ...
      bookAsset: 'assets/png/books/ether_cry.png',
      angle: 26,
    ...
    Potion(
      ...
      bookAsset: 'assets/png/books/mist_drop.png',
      type: PotionType.normal,
    ...
    Potion(
      ...
      bookAsset: 'assets/png/books/sweet_bubble.png',
      angle: 7,
      type: PotionType.common,
    ...
    Potion(
      ...
      bookAsset: 'assets/png/books/crystal_dream.png',
      type: PotionType.rare,
    ...
    Potion(
      ...
      bookAsset: 'assets/png/books/shadow_elixir.png',
      angle: 26,
      type: PotionType.veryRare,
    ...
    Potion(
      ...
      bookAsset: 'assets/png/books/forest_dust.png',
      angle: 17,
      type: PotionType.normal,
    ...
    Potion(
      ...
      bookAsset: 'assets/png/books/dew_of_piece.png',
      angle: 18,
      type: PotionType.common,
    ...
    Potion(
      ...
      bookAsset: 'assets/png/books/ashen_glow.png',
      type: PotionType.rare,
    ...
    Potion(
      ...
      bookAsset: 'assets/png/books/timeless_surge.png',
      angle: 22,
      type: PotionType.veryRare,
  ...
  static List<Potion> get normalPotions =>
      potionsList.where((e) => e.type == PotionType.normal).toList();

  static List<Potion> get commonPotions =>
      potionsList.where((e) => e.type == PotionType.common).toList();

  static List<Potion> get rarePotions =>
      potionsList.where((e) => e.type == PotionType.rare).toList();

  static List<Potion> get veryRarePotions =>
      potionsList.where((e) => e.type == PotionType.veryRare).toList();
}
